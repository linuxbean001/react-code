                ...
                <section id="hero_banner" className="hero_banner height100">
                    <div className="container custom_container height100 display_table">
                        ...
                        <div className="hero_img">
                            <img src="images/smart-technology.png" alt=""/>
                        </div>
                        <div className="hero_txt">
                            ...
                            <Link to={'/'} className="btn custom_theme_btn">Register to Beta</Link>
                        </div>
                        <div className="arrow_banner links_anchor">
                            <Link to={"/about_us"}><img src="images/arrow.png" alt=""/></Link>
                        </div>
                    </div>
                </section>
                            ...
                            <Tabs defaultActiveKey={1} id="uncontrolled-tab-example">
                                    ...
                                    <div className="platform_slider">
                                        <div className="col-md-4 col-sm-4">
                                            <div className="platform_grid">
                                                <img src="images/simplify.png" alt=""/>
                                        ...
                                        <div className="col-md-4 col-sm-4">
                                            <div className="platform_grid">
                                                <img src="images/best-deal.png" alt=""/>
                                ...
                                <Tab eventKey={2} title="Estate Agents">
                                    <div className="platform_slider">
                                        <div className="col-md-4 col-sm-4">
                                            <div className="platform_grid">
                                                <img src="images/be-first.png" alt=""/>
                                        ...
                                        <div className="col-md-4 col-sm-4">
                                            <div className="platform_grid">
                                                <img src="images/loyal-clients.png" alt=""/>
                                        ...
                                        <div className="col-md-4 col-sm-4">
                                            <div className="platform_grid">
                                                <img src="images/optimise.png" alt=""/>
                                ...
                                <Tab eventKey={3} title="Investors">
                                    <div className="platform_slider">
                                        <div className="col-md-4 col-sm-4">
                                            <div className="platform_grid">
                                                <img src="images/get-ahead.png" alt=""/>
                                        ...
                                        <div className="col-md-4 col-sm-4">
                                            <div className="platform_grid">
                                                <img src="images/save-time.png" alt=""/>
                        ...
                        <div className="contact_content">
                            ...
                            <div className="row">
                                <div className="cont_img">
                                    <img src="images/Register_your_interest.png" alt=""/>
                                </div>
